const gemmaQuoteBank = [
    ...
    "Borzasztóak vagyunk, igaz? Lehet. De így talán esélyünk van arra, hogy elfogadják a kevésbé rossz oldalunkat és mi igazán nem kérünk sokat, igaz, Mal? Vegyetek észre, fogadjatok el... Mentsetek meg! De még ahhoz is gyávák vagyunk, hogy elengedjük azt, ami ilyenné tett minket. Hiszen mi marad nekünk a végén akkor?",
    ...
    "Tekintetem elmereng, míg meg nem állapodik rajtad, Gemma. Gyönyörű vagy abban a ruhában és O’Hara mellett… csak úgy sugárzol. Fájdalmasan dobban szívem és bevallom, ez meglep. Azt hiszem, már nem lesz alkalmam elmondani neked, hogy mennyire hálás vagyok. Akkor este megmentettél önmagamtól, csendet teremtettél számomra a zajongó világomban. Remélem, boldog vagy. Remélem, jó lesz hozzád.",
